    ...
    return (
      ...
      <div className="container" style={ {backgroundColor: "white", borderStyle: "solid", borderWidth: "1px"} }>
        ...
        <div className="page-header">
          <h1 className="text-center"><img style={ {width: "70%"} } src="img/nyt-header.svg" alt="The New York Times Logo"/></h1>
          <h2 className="text-center" style={ {marginTop: "-12px"} }><b><i>A MERN App</i></b></h2>
          <h4 className="text-center">Search for and save NYT articles!</h4>
        </div>
